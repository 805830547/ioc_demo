...
public class BeanFactory {
    ...
    public static ParseXML parseXML = new ParseXML();
    public static Map<String, Map<String, Object>> beanXML = parseXML.parseIOC("application.xml");
    ...
    private static void invoke(Map<String, Object> beanDesc) {
        ...
        try {
            ...
            List<Map<String, Object>> methodList = getBeanSetMethod(beanClass,
                    (List<Map<String, String>>) beanDesc.get("property"));
    ...
    private static List<Map<String, Object>> getBeanSetMethod(Class<?> beanClass,
    ...
    private static Method getSetMethod(Class<?> beanClass, Map<String, String> propertyMap) {
